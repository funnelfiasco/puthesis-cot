...
%     This template has been tested using TeX Live 2011
%
...
%   ------------------------------------------------------------------------------------------------------------------------
% This section was found in the previous CoT LaTeX template. It is unknown whether this section is needed at all, but it is being retained for reference. --Jason St. John (2012-02-05)
%
