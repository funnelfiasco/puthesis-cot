%
%  revised  thesis.tex  2012-09-12  Jason St. John <jstjohn@purdue.edu>
...
%
% 'tech' is for all theses and dissertations in the CoT
% 'thesisproposal' is for M.S. thesis proposals
% 'dissertationproposal' is for Ph.D. dissertation proposals
% 'nochapterblankpages' removes the requirement that chapters must start on odd-numbered pages
% 'apacite' is the correct style for the CoT
% CHANGE NEXT LINE?
\documentclass[tech,thesisproposal,apacite,nochapterblankpages]{puthesis-cot}
...
% Unfortunately, the "indentfirst" package does not work with the first paragraph 
...
% Create an "italicdesc" environment for use in the "Definitions" section. This
% is provided by the "enumitem" package.
\usepackage{enumitem}
...
% CHANGE NEXT LINE?
\pudegree{Doctor of Philosophy}{Ph.D.}{December}{2012}
\pudegree{Master of Science}{M.S.}{December}{2012}
